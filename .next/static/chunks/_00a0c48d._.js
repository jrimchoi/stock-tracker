...
"[project]/lib/actions/data:9efd1b [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"7f178f0fa968fe041e563395d8fcc7f0dae3a29774":"signInWithEmail"},"lib/actions/auth.actions.ts",""] */ __turbopack_context__.s([
    "signInWithEmail",
    ()=>signInWithEmail
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$9efd1b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/actions/data:9efd1b [app-client] (ecmascript) <text/javascript>");
...
const SignIn = ()=>{
    ...
    const onSubmit = async (data)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$9efd1b__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["signInWithEmail"])(data);
            if (result.success) router.push('/');
        } catch (e) {
            console.error(e);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Sign in failed', {
...
_s(SignIn, "7X/R1tlCXryNMA9zLI/BTFrmV5c=", false, function() {
    return [
...
//# sourceMappingURL=_00a0c48d._.js.map